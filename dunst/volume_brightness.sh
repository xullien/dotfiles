...
volume_step=5
brightness_step_up=+5%
brightness_step_down=5%-
max_volume=100
...
function get_brightness {
    brightnessctl | grep -oP '\(\K\d+%' | head -n 1
...
case $1 in
    ...
    brightnessctl set +$brightness_step_up 
    show_brightness_notif
    ;;

    brightness_down)
    # Decreases brightness and displays the notification
    brightnessctl set +$brightness_step_down
    show_brightness_notif
    ;;
